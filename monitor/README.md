...
Sistem deteksi status keberadaan karyawan dari video CCTV berbasis Upper-Body detection (YOLO11) dan zona kursi statis.

## Konsep Utama
- **Status Presence**: **BEKERJA** (Hijau) & **TIDAK DI TEMPAT** (Merah).
- **Upper Body Detection**: Menggunakan YOLO11 Person (class 0) yang dipotong menjadi upper-body secara otomatis.
